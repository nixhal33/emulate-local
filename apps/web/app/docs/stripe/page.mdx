...
Stripe API emulation with customers, payment methods, customer sessions, payment intents, charges, products, prices, and checkout sessions. Includes a hosted checkout page.
...
Outbound webhook callback delivery is not implemented in the native Stripe engine yet. Modeled event names include:
